...
final class ReportClientScript {
    ...
    private static final String SCRIPT_PART_1 =
            ...
            + "  var price = (Number.isFinite(marketPrice) && marketPrice > 0) ? marketPrice : 0;\n"
            + "  if (!price) {\n"
            ...
            + "    }\n"
            + "  }\n"
            + "  // Prior session close = 2nd-to-last daily close; chartPreviousClose spans the whole 5d window.\n"
            + "  var prevClose = 0;\n"
