...
final class ReportClientScript {
    ...
    static void write(FileWriter writer, Map<String, Double> ratesToNok) throws IOException {
        ...
        writer.write("  var dividerRow = null, stockSubtotalRow = null, fundSubtotalRow = null;\n");
        writer.write("  allRows.forEach(function(row) {\n");
        writer.write("    if (!row.classList) return;\n");
        writer.write("    if (row.hasAttribute && row.hasAttribute('data-asset-divider')) { dividerRow = row; }\n");
        writer.write("    else if (row.classList.contains('asset-subtotal-row')) {\n");
        ...
        writer.write("      }\n");
        writer.write("    } else if (group.assetGroup === 'FUND' && previousGroup === 'STOCK') {\n");
        writer.write("      if (stockSubtotalRow) body.appendChild(stockSubtotalRow);\n");
        writer.write("      body.appendChild(dividerRow);\n");
        writer.write("    }\n");
        ...
        writer.write("  });\n");
        writer.write("  if (useDivider && fundSubtotalRow) body.appendChild(fundSubtotalRow);\n");
